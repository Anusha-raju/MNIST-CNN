...
class Net(nn.Module):
    def __init__(self):
        ...
        self.convblock1 = nn.Sequential(
            self.depthwise_separable_conv(1, 10, kernel_size=3, padding=1),
            nn.BatchNorm2d(10),
            nn.ReLU(),
            nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False),
            nn.BatchNorm2d(10),
            nn.ReLU(),
            self.depthwise_separable_conv(10, 10, kernel_size=3, padding=1),
            nn.BatchNorm2d(10),
            nn.ReLU(),
            nn.Conv2d(in_channels=10, out_channels=10, kernel_size=(3, 3), padding=1, bias=False),
            nn.BatchNorm2d(10),
            ...
            nn.BatchNorm2d(10),
            nn.ReLU(),
            self.depthwise_separable_conv(10, 13, kernel_size=3, padding=1),
            nn.BatchNorm2d(13),
            nn.ReLU(),
        )
        ...
        self.convblock2 = nn.Sequential(
            self.depthwise_separable_conv(13, 10, kernel_size=1, padding=0),
            ...
            nn.BatchNorm2d(13),
            nn.ReLU(),
            nn.Conv2d(in_channels=13, out_channels=13, kernel_size=(3, 3), padding=1, bias=False),
            nn.BatchNorm2d(13),
            nn.ReLU(),
            self.depthwise_separable_conv(13, 13, kernel_size=3, padding=1),
            nn.BatchNorm2d(13),
            nn.ReLU(),
            self.depthwise_separable_conv(13, 13, kernel_size=3, padding=1),
            nn.BatchNorm2d(13),
